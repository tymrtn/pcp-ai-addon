...
/**
 * AI-powered review check for Accessibility category.
 */
class AI_Review_Accessibility extends AI_Review_General {
	...
	protected function check_files( \WordPress\Plugin_Check\Checker\Check_Result $result, array $files ) {
		$this->run_ai_analysis( $result, $files, 'accessibility', 'Accessibility standards and WCAG compliance' );
	}
	...
	public function get_description(): string {
		return __( 'Provides AI-powered analysis of Accessibility category issues.', 'pcp-ai-addon' );
	}
}
